...
"""
Patches 12, 13 for pipeline/backtest.py
Patch 11 already applied.
...
OLD_12 = '''    log_odds_shift = WarPayoff + WarPolitics + HardlineDirect + q_logit
...
NEW_12 = '''    # Patch 12: Drop peacetime intercept entirely.
    ...
    window_log_odds = q_logit + SSPE_SHRINKAGE * sspe_deviations  # no peacetime intercept'''
